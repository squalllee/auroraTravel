...
const App: React.FC = () => {
  ...
  const [activeDayId, setActiveDayId] = useState<string>(ITINERARY[0].id);
  ...
  const handleDragStart = (e: React.DragEvent<HTMLDivElement>, index: number) => {
    ...
    // Set invisible drag image or style if needed, but default is usually okay
  ...
  const handleAddItem = (newItemData: Partial<ItineraryItem>) => {
